          ...
          <div class="w-6/12 mx-auto rounded border">
            <div class="bg-white p-10 shadow-sm">
              ...
              <div class="transition hover:bg-indigo-50">
                <!-- header -->
                <div @click="activeIndex=0" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
              ...
              <div class="transition hover:bg-indigo-50">
                <!-- header -->
                <div @click="activeIndex=1" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
              ...
              <div class="transition hover:bg-indigo-50">
                <!-- header -->
                <div @click="activeIndex=2" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
              ...
              <div class="transition hover:bg-indigo-50">
                <!-- header -->
                <div @click="activeIndex=3" class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                  <i class="fas fa-plus"></i>
